...
<body>
	...
	<div class="container" >
		...
		<div class="home-top" style="margin-left: -120px;">
            ...
            <li><a href="myInfo.action" target="mainFrame" >我的个人信息</a><br></li>
            
            <li><a href="myOrder.action" target="mainFrame">我的订单</a><br></li>
           </ul>
            </td>
            <td width="100%" valign="top"><iframe scrolling="no" style="margin-top: -130px;margin-left: -30px;" src="myInfo.action"   name="mainFrame" frameborder="0" marginheight="0" marginwidth="0" height="700" width="115%"></iframe></td>
            </tr>
            </table>
		</div>
	</div>
