...
<body>
	...
	<div class="container" >
		...
		<div class="home-top" style="margin-left: -120px;">
            ...
            <td width="100%" valign="top"><iframe scrolling="yes"   style="margin-top: -130px;margin-left: -30px;" src="myInfo.action?u_id=${u_id }"   name="mainFrame" frameborder="0" marginheight="0" marginwidth="0" height="700" width="115%"></iframe></td>
            </tr>
            </table>
		</div>
	</div>
