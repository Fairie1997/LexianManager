...
<body>
		...
		<div class="header-top">
			<div class="container">
				...
				<div class="input-group float-md-right"
					style="width: 300px; margin-top: -30px; margin-right: -50px;">
					<form
						action="${pageContext.request.contextPath }/getProduct.action"
	...
	<div class="banner-top ">
		<div class="container">
			...
			<em></em>
			<h2>
				<a href="index.jsp">首页</a><label>/</label>商品
			</h2>
		</div>
	</div>
	<!--content目录-->
	...
	<ul class="nav navbar-nav nav_1 "
		style="list-style: none; display: inline-block; text-align: justify">
		<div
			style="float: left; width: 88%; height: 700px; margin-top: 20px; margin-left: 180px; display: inline-block; white-space: nowrap;">

			<c:forEach items="${commodityShowList }" var="commodity">
				<div
					style="float: left; height: auto; margin-left =20px; display: inline-block; text-align: justify">
					<div class="goods">
						<ul
							style="list-style: none; display: inline-block; text-align: justify">
							<li><a
								href="${pageContext.request.contextPath }/commodity.action?com_no=${commodity.com_no}"><img
									alt="" src="${commodity.pictureurl }"
	...
	<div style="text-align:center;">
		...
		<div class="col-sm-5 col-md-offset-2 header-login float-right">
			...
			<form action="${pageContext.request.contextPath }/getProduct.action"
				method="post">
				<input type="hidden" name="com_name" value="${pageUtil.com_name }" />
				<input type="hidden" name="pageIndex" value="1"> <input
					type="submit" value="首页"
					style="border: none; background: none; cursor: pointer; font-size: 17px;width:20px;height:20px" />
			</form>
			</li><li>
			<form action="${pageContext.request.contextPath }/getProduct.action"
				method="post">
				...
				<input type="hidden" name="pageIndex"
					value="${pageUtil.pageIndex>1?pageUtil.pageIndex-1:1}"> <input
			...
			<c:forEach begin="1" end="${pageUtil.pageCount}" var="i">
				<li><form action="${pageContext.request.contextPath }/getProduct.action"
					method="post">
					<input type="hidden" name="com_name" value="${pageUtil.com_name }" />
					<input type="hidden" name="pageIndex" value="${i}"> <input
						type="submit" value="${i}"
						style="border: none; background: none; cursor: pointer; font-size: 17px;" />
				</form></li>
			</c:forEach>
			...
			<form action="${pageContext.request.contextPath }/getProduct.action"
				...
				<input type="hidden" name="com_name" value="${pageUtil.com_name }" />
				<input type="hidden" name="pageIndex"
					value="${pageUtil.pageIndex<pageUtil.pageCount?pageUtil.pageIndex+1:pageUtil.pageCount}">
			...
			<form action="${pageContext.request.contextPath }/getProduct.action"
				method="post">
				<input type="hidden" name="com_name" value="${pageUtil.com_name }" />
				<input type="hidden" name="pageIndex" value="${pageUtil.pageCount}">
