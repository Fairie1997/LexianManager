...
<body>
   ...
   <section class="cartMain">
        ...
        <div class="cartBox">
            ...
            %>
				<ul class="order_lists">
                    <li class="list_chk">
                    	<input type="hidden" id="u_phone" value="${u_phone }">
                    	<input type="hidden" name="${sto_namex }" value="${sto_name }">	
                    	<input type="hidden" name="${pictureurlx }" value="${pictureurl }">	
                    	<input type="hidden" name="${com_nox }" value="${com_no }" id="com_no">
                    	<input type="hidden" name="${sto_nox }" value="${sto_no }" id="sto_no">
    ...
    <section class="my_model"style="height:150px;>
