...
<html>
	...
	<body>
		...
		<div class="jumbotron text-center " style="background-image: url(img/bei2.png); background-size: cover;">
			<h1 style="color:#FFFFFF ;margin-top: -30px;" class="float-left">乐鲜生活用户注册</h1>
		</div>
			...
			<div class="card" style="width:650px" >
				<div class="card-body">
					...
					<form id="RegisterForm" action="${pageContext.request.contextPath }/Uregister.action" method="post">
				        ...
				        <a href="quit.action" type="button" class="btn btn-primary">返回</a>
				        <p>${fail }</p>
					</form>
				</div>
			</div>
