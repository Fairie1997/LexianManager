...
<body>
	<div class="container"style="margin-left: 130px; width: 120%;">
		<div>
			<h5>取货门店</h>
		<hr class="m-lg-2">
		</div>
		...
		<div>
     	...
     	<div class="payment-methods fix">
											<div class="single-payment cheque">
												<button class="select-btn active"><span class="check-box"></span>PayPal</button>
												<p>Please send your cheque to Store Name, Store Street, Store Town, Store State / County, Store Postcode.</p>
											</div>
											
											<div class="single-payment other">
												<div class="wrapper">
													<a href="#" class="paypal"><img src="img/paypal.png" alt="paypal" / style="width: 100%;height: 100%;"></a>
													<a href="#" class="visa"><img src="img/visa.png" alt="visa" /></a>
													<a href="#" class="mastercard"><img src="img/mastercard.png" alt="mastercard" /></a>
													<a href="#" class="express"><img src="img/express.png" alt="express" /></a>
													<a href="#" class="jcb"><img src="img/jcb.png" alt="jcb" /></a>
												</div>
		...
		<div>
			<h5>取货方式</h5>
			<hr class="m-lg-2">
			 <input type="text" class="form-control " placeholder="到店取货"style="width: 150px;">
		</div>
		<div class=time>
			<h5>取货时间</h5>
			<hr class="m-lg-2">
  ...
  <div>
                <input type="radio" name="paixu" id="today" checked>
                <label for="today" style="cursor:pointer">当天</label>
                <input type="radio" name="paixu" id="tday">
                <label for="tday" style="cursor:pointer">三天内</label>
                <input type="radio" name="paixu" id="wday">
                <label for="wday" style="cursor:pointer">一周内</label>
            </div>
    ...
    <%
    	...
    	for(int i=0;i<com_num;i++)
    	{
    		...
    		%>
				<h5>订单编号：<span><strong id="ono">${order_no }</strong></span></h5>
				<h5>取货门店：<span><strong id="ono">${sto_name }</strong></span></h5>
				<table class="table table-striped"style=" width=200%;height=100%;">
					<thead>
						<tr>
							<th>商品</th>
							<th>商品简介</th>
			...
			<%} %>
      <tr>
        <td><div class="list_img"><a href="javascript:;"><img src="${pictureurl }" alt="" style=""></a></div></td>
        <td>${introduce }</td>
        <td>${listprice }</td>
        <td>${amount }</td>
        <td>${totalprice }</td>
  ...
  <div class="card-block">
    <h3 >应付总额：<span><strong id="totalPrice" class="text-danger">${total_amount }</strong>元</span></h3>
    <p class="card-text"></p>
    <button type="button" class="btn btn-light center-block" style="text-align: center;">返回购物车</button>
    <button type="button" class="btn btn-danger center-block" data-toggle="modal" data-target="#myModal"style="text-align: center;">提交订单</button>
  </div>
</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a type="button" class="btn btn-danger" href="orderdetails.jsp">查看订单</a>
