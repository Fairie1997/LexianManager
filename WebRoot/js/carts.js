...
$('.dialog-sure').click(function () {
    ...
    var json = [];
    var j = {};
    j.u_phone = document.getElementById("u_phone").value;
    j.com_no = document.getElementById("com_no").value;
    j.sto_no = document.getElementById("sto_no").value;
    json.push(j);
    $.ajax({
    	async:false,
	    cache: false,
        type: "POST",
        url: "http://localhost:8080/LexianManager/removeTrolley.action",
