...
-->
	...
	<div id="demo" class="carousel slide "
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img style="width: 1000px; height: 390px;" src="img/lun1.jpg">

			</div>
			<div class="carousel-item">
				<img style="width: 1000px; height: 390px;" src="img/lun2.jpg">

			</div>
			<div class="carousel-item">
				<img style="width: 1000px; height: 390px;" src="img/lun3.jpg">
		...
		</a> <a class="carousel-control-next " style="margin-right: 280px;"
	...
	<div class="float-right">
		<a href="byCategory.action?cat_id=219&type=1"><img style="margin-top: -730px; margin-right: -200px; width: 200px;"
			src="img/ada1.jpg" > </a>
		<a href="byCategory.action?cat_id=219&type=1"><img style="margin-top: -280px; margin-right: 40px; width: 200px;"
			src="img/ada2.jpg" ></a>
	</div>
	...
	<ul class="nav navbar-nav nav_1 ">
		<div
			...
			<div style="float: left; height: auto;">
				<div class="goods">
					<ul style="list-style: none; display: inline-block;">
						<li><a href="byCategory.action?cat_id=50&type=1"><img alt="" src="img/bangong.jpg"
								style="width: 200px; height: 200px; margin-left: 110px;"></a></li>

					</ul>

					<ul style="list-style: none; display: inline-block;">
						<li><a href="byCategory.action?cat_id=153&type=3"><img alt="" src="img/chufang.jpg"
								style="width: 200px; height: 200px;"></a></li>

					</ul>

					<ul style="list-style: none; display: inline-block;">
						<li><a href="byCategory.action?cat_id=50&type=1"><img alt="" src="img/dianqi.jpg"
								style="width: 200px; height: 200px;"></a></li>

					</ul>

					<ul style="list-style: none; display: inline-block;">
						<li><a href="byCategory.action?cat_id=144&type=2"><img alt=""
			...
			<div style="float: left; height: auto; margin-top: 40px">
				<div class="goods">
					<ul style="list-style: none; display: inline-block;">
						<li><a href="byCategory.action?cat_id=158&type=1"><img alt="" src="img/jiaju.jpg"
								style="width: 200px; height: 200px; margin-left: 110px;"></a></li>

					</ul>

					<ul style="list-style: none; display: inline-block;">
						<li><a href="byCategory.action?cat_id=49&type=1"><img alt="" src="img/lingshi.jpg"
								style="width: 200px; height: 200px;"></a></li>

					</ul>

					<ul style="list-style: none; display: inline-block;">
						<li><a href="byCategory.action?cat_id=226&type=3"><img alt="" src="img/naizhi.jpg"
								style="width: 200px; height: 200px;"></a></li>

					</ul>

					<ul style="list-style: none; display: inline-block;">
						<li><a href="byCategory.action?cat_id=46&type=1"><img alt="" src="img/shuiguo.jpg"
								style="width: 200px; height: 200px;"></a></li>

					</ul>

					<ul style="list-style: none; display: inline-block;">
						<li><a href="byCategory.action?cat_id=52&type=2"><img alt="" src="img/yinliao.jpg"
								style="width: 200px; height: 200px;"></a></li>
			...
			<div style="float: left; height: auto; margin-top: 40px">
				<div class="goods">
					<ul style="list-style: none; display: inline-block;">
						<li><a href="byCategory.action?cat_id=115&type=2"><img alt="" src="img/you.jpg"
								style="width: 200px; height: 200px; margin-left: 110px;"></a></li>

					</ul>

					<ul style="list-style: none; display: inline-block;">
						<li><a href="byCategory.action?cat_id=52&type=2"><img alt="" src="img/naizhi.jpg"
								style="width: 200px; height: 200px;"></a></li>

					</ul>

					<ul style="list-style: none; display: inline-block;">
						<li><a href="byCategory.action?cat_id=49&type=1"><img alt="" src="img/baojian.png"
								style="width: 200px; height: 200px;"></a></li>

					</ul>

					<ul style="list-style: none; display: inline-block;">
						<li><a href="byCategory.action?cat_id=142&type=2"><img alt=""
								src="img/hufu.jpg" style="width: 200px; height: 200px;"></a></li>

					</ul>

					<ul style="list-style: none; display: inline-block;">
						<li><a href="byCategory.action?cat_id=141&type=2"><img alt=""
		...
		<!--脚页-->
		<div class="footer " style="width: 1524px;">
			<center>
