			...
			<div class="container">
					<div class="col-sm-5 col-md-offset-2 header-login float-right">
						...
						<c:if test="${not isLogin}">
							...
							<li><a href="userReg.jsp">我的个人中心</a></li>
						</c:if>
						<c:if test="${isLogin}">
			                    ...
			                    <div class="menu-top">
									<div class="col1 ">
											...
											<ul>	
												...
												<li>
													<form action="${pageContext.request.contextPath }/getProduct.action" method="post">
														...
														<input type="submit"  value="T恤" style="border:none;background:none;cursor:pointer;font-size:13px;"/>
													</form>
												</li>
												<li><a href="${pageContext.request.contextPath }/findCommodityDetail.action?com_no=${commodity.com_no}">衬衫</a></li>
												<li><a href="product.jsp">外套 &nbsp;&nbsp;&nbsp;</a></li>
										...
										<div class="col1 ">	
											...
											<h5>浪漫裙装</h5>
											<ul>	
												<li><a href="product.jsp">连衣裙 &nbsp;&nbsp;&nbsp;</a></li> 
												<li><a href="product.jsp">半身裙 &nbsp;&nbsp;&nbsp;</a></li>
												<li><a href="product.jsp">牛仔裙&nbsp;&nbsp;&nbsp;</a></li>
												<li><a href="product.jsp">A字裙&nbsp;&nbsp;&nbsp;</a></li>
												<li><a href="product.jsp">荷叶边群 &nbsp;&nbsp;&nbsp;</a></li>
											</ul>
										</div>
										<div class="col1 ">
											<br />
											<h5>精选上装</h5>
											<ul>	
												<li><a href="product.jsp">羽绒服&nbsp;&nbsp;&nbsp;</a></li> 
												<li><a href="product.jsp">卫衣&nbsp;&nbsp;&nbsp;</a></li>
												<li><a href="product.jsp">风衣 &nbsp;&nbsp;&nbsp;</a></li>
												<li><a href="product.jsp">针织衫 &nbsp;&nbsp;&nbsp;</a></li>
							...
							<div class="dropdown-menu mega-dropdown-menu" style="margin-left:174px;margin-top:-188px;">
			                    <div class="menu-top">
									<div class="col1 ">
											...
											<h5>护肤品</h5>
											<ul>	
												<li><a href="product.jsp">面膜 &nbsp;&nbsp;&nbsp;</a></li> 
												<li><a href="product.jsp">精华液&nbsp;&nbsp;&nbsp;</a></li>
												<li><a href="product.jsp">护手霜&nbsp;&nbsp;&nbsp;</a></li>
												<li><a href="product.jsp">爽肤水 &nbsp;&nbsp;&nbsp;</a></li>
												<li><a href="product.jsp">洁面 &nbsp;&nbsp;&nbsp;</a></li>
												<li><a href="product.jsp">卸妆&nbsp;&nbsp;&nbsp;</a></li>
											</ul>
										</div>
										<div class="col1 ">	
											<br />
											<h5>彩妆</h5>
											<ul>	
												<li><a href="product.jsp">香水 &nbsp;&nbsp;&nbsp;</a></li> 
												<li><a href="product.jsp">BB霜&nbsp;&nbsp;&nbsp;</a></li>
												<li><a href="product.jsp">口红&nbsp;&nbsp;&nbsp;</a></li>
												<li><a href="product.jsp">隔离&nbsp;&nbsp;&nbsp;</a></li>
												<li><a href="product.jsp">眼影 &nbsp;&nbsp;&nbsp;</a></li>
											</ul>
										</div>
										<div class="col1 ">
											<br />
											<h5>美发护发</h5>
											<ul>	
												<li><a href="product.jsp">洗发水&nbsp;&nbsp;&nbsp;</a></li> 
												<li><a href="product.jsp">护发素&nbsp;&nbsp;&nbsp;</a></li>
												<li><a href="product.jsp">假发&nbsp;&nbsp;&nbsp;</a></li>
												<li><a href="product.jsp">护发精油 &nbsp;&nbsp;&nbsp;</a></li>
												<li><a href="product.jsp">染发霜&nbsp;&nbsp;&nbsp;</a></li>
											</ul>
										</div>
										<div class="col1 ">
											<br />
...
<div id="demo" class="carousel slide " style="margin-top: -380px;margin-left: 670px;margin-right: 50px;" data-ride="carousel">
  ...
  <div class="carousel-inner" >
    <div class="carousel-item active">
      <img style="width: 900px;height: 350px;" src="http://static.runoob.com/images/mix/img_fjords_wide.jpg">
      
    </div>
    <div class="carousel-item">
      <img style="width: 900px;height: 350px;" src="http://static.runoob.com/images/mix/img_nature_wide.jpg">
      
    </div>
    <div class="carousel-item">
      <img style="width: 900px;height: 350px;" src="http://static.runoob.com/images/mix/img_mountains_wide.jpg">
...
<div  style="float: left;width:980px;height:700px; margin-top: 20px; display: inline-block;white-space: nowrap;">
			...
			<div style="float:left;height:auto;">
				...
				<ul style="list-style: none;display: inline-block;">
					<li><a href="commodity.jsp"><img alt="" src="img/2.jpg" style="width: 200px; height: 200px;"></a></li>
				...
				<ul style="list-style: none;display: inline-block;">
					<li><a href="commodity.jsp"><img alt="" src="img/3.jpg" style="width: 200px; height: 200px;"></a></li>
					<div style="margin-left:22px;">
					<li>商品ID</li>
					<li>商品价格</li>
					<li>商品介绍</li>
