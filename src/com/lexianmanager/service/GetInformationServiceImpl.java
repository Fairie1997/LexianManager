...
public class GetInformationServiceImpl implements GetInformationService {
	...
	@Override
	public void deleteOrder(String o_no) {
		// TODO Auto-generated method stub
		orderDao.deleteOrder(o_no);
	}
	

	@Override
	public String findCat_name(int cat_id) {
		// TODO Auto-generated method stub
		return categoryDao.findCat_name(cat_id);
	}



	@Override
	public int getO_id(String o_no) {
		// TODO Auto-generated method stub
		return orderDao.findOid(o_no);
	}

	@Override
	public void deleteOrderItemByO_id(int o_id) {
		// TODO Auto-generated method stub
		orderDao.deleteOrderItemByO_id(o_id);
	}
